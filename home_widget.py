...
class Ui_homeForm(object):
    def setupUi(self, homeForm):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(-28, 1, 1461, 721))
...
"background: #5968B0;")
        ...
        self.clearFilesButton = QtWidgets.QPushButton(self.widget)
...
"background: #5968B0;")
        ...
        self.fileFolderListWidget = QtWidgets.QListWidget(self.layoutWidget)
...
"background: white;")
        self.fileFolderListWidget.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.fileFolderListWidget.setFrameShadow(QtWidgets.QFrame.Plain)
        self.fileFolderListWidget.setObjectName("fileFolderListWidget")
        self.verticalLayout.addWidget(self.fileFolderListWidget)
        self.createSelectButton = QtWidgets.QPushButton(self.layoutWidget)
