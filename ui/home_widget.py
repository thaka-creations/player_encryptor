...
"background: white;")
        ...
        self.fileFolderListWidget.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.fileFolderListWidget.addItem(item)
...
"color: white;")
    ...
    def retranslateUi(self, homeForm):
        ...
        __sortingEnabled = self.fileFolderListWidget.isSortingEnabled()
        self.fileFolderListWidget.setSortingEnabled(False)
        item = self.fileFolderListWidget.item(0)
        item.setText(_translate("homeForm", "test"))
        item = self.fileFolderListWidget.item(1)
        item.setText(_translate("homeForm", "testing this"))
        self.fileFolderListWidget.setSortingEnabled(__sortingEnabled)
